...
def simulate_trucks(mass, nominalPower, CD0, wind_amplitude=10.5, wind_frequency_hz=0.01):
    # omega_hz = wind_frequency_hz
    #  Correcto: omega_hz ya está definido
    # Parámetros del sistema
    n_tr = 0.9    # eficiencia
    Af = 9.5      # área frontal m^2
    rho = 1.225   # kg/m³
    minDist = 60  # m
    energia_combustible = 34.2e6  # J/L
    gravity = 9.81
...
# 0.01 Hz (lento)
results1 = simulate_trucks(mass=30000, nominalPower=200e3, CD0=0.7, wind_frequency_hz=0.01)
plot_truck_results(results1, output_dir='resultados_simulacion/omega_0.01Hz')

# 0.1 Hz (más rápido)
results2 = simulate_trucks(mass=30000, nominalPower=200e3, CD0=0.7, wind_frequency_hz=0.1)
plot_truck_results(results2, output_dir='resultados_simulacion/omega_0.1Hz')

# 0.5 Hz (más oscilaciones por segundo)
results3 = simulate_trucks(mass=30000, nominalPower=200e3, CD0=0.7, wind_frequency_hz=0.5)
plot_truck_results(results3, output_dir='resultados_simulacion/omega_0.5Hz')


# Simulación con amplitud 5 m/s
results_a1 = simulate_trucks(mass=30000, nominalPower=200e3, CD0=0.7, wind_amplitude=25, wind_frequency_hz=0.1)
plot_truck_results(results_a1, output_dir='resultados_simulacion/amplitud_25ms')

# Simulación con amplitud 10 m/s
results_a2 = simulate_trucks(mass=30000, nominalPower=200e3, CD0=0.7, wind_amplitude=10, wind_frequency_hz=0.1)
plot_truck_results(results_a2, output_dir='resultados_simulacion/amplitud_10ms')

# Simulación con amplitud 15 m/s
results_a3 = simulate_trucks(mass=30000, nominalPower=200e3, CD0=0.7, wind_amplitude=50, wind_frequency_hz=0.1)
plot_truck_results(results_a3, output_dir='resultados_simulacion/amplitud_50ms')